...
echo "#############################################################"
echo "# 感谢各位大佬对N宅的支持！                                 #"
echo "# 本服务器提供的ss服务将无偿供给所有N宅及天朝网民使用       #"
echo "# Author: Teddysun <i@teddysun.com>                         #"
echo "# Modified by N宅宅主 <blog.liujason.com>                   #"
echo "#############################################################"
echo
...
pre_install(){
    ...
    [ -z "${shadowsockspwd}" ] && shadowsockspwd="notaku"
    echo
    echo "---------------------------"
    ...
    while true
    do
    [ -z "$shadowsocksport" ] && shadowsocksport="10001"
...
install(){
    ...
    echo
    echo "Please reply this information to http://service.liujason.com "
    echo "Thank you!"
    echo
}
